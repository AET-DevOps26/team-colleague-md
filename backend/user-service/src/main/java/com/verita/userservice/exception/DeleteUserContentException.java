...
public class DeleteUserContentException extends RuntimeException {
    ...
    public DeleteUserContentException(UUID userId, String downstreamService, String endpoint,
